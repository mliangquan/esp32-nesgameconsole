...
static const char *translations[][RG_LANG_MAX] =
{
    ...
    // end of rg_system.c
    {
        [RG_LANG_EN] = "Frameskip phase",
        [RG_LANG_FR] = "Phase de saut d'image",
        [RG_LANG_DE] = "Frameskip-Phase",
    },
    {
        [RG_LANG_EN] = "Every 4 frames",
        [RG_LANG_FR] = "Toutes les 4 frames",
        [RG_LANG_DE] = "Alle 4 Frames",
    },
    {
        [RG_LANG_EN] = "Every 8 frames",
        [RG_LANG_FR] = "Toutes les 8 frames",
        [RG_LANG_DE] = "Alle 8 Frames",
    },
    {
        [RG_LANG_EN] = "Every 16 frames",
        [RG_LANG_FR] = "Toutes les 16 frames",
        [RG_LANG_DE] = "Alle 16 Frames",
    },
};
