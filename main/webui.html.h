...
"        <progress value='0' max='0' id='spacebar'></progress>"
"        <label id='spaceinfo' style='padding-left:.5em;'></label>"
"    </div>"
"    <script>"
"        let current_path = '';"
"        function $(selector) {"
...
"                $('#status').innerText = '';"
"                $('#spacebar').value = this.response.totalspace - this.response.freespace;"
"                $('#spacebar').max = this.response.totalspace;"
"                $('#spaceinfo').innerText = this.response.freespace + ' bytes free, total: ' + this.response.totalspace + ' bytes';"
"                current_path = path;"
"            });"
"        }"
"        update_view('"RG_STORAGE_ROOT"');"
"    </script>"
"</body>"
"</html>"
};
